...
Be sure to utilize the [MYSQL Heroku Deployment Guide](https://github.com/UCF-Coding-Boot-Camp/2017-07-LM-Class-Repository-FSF/blob/master/resources/MySQLHerokuDeploymentProcess.pdf) in order to deploy your assignment.
